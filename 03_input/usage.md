...
1. 采集 `daily.md`、`flomo.md`、`weread.md`、`voice.md`、`calendar.md` 和 `coach.md`，不采集周记，不生成 `_dist`。
...
- [ ] 自动采集项按实际情况生成：`daily.md`、`flomo.md`、`weread.md`、`voice.md`、`calendar.md`、`coach.md`。
