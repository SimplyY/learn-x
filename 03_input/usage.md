...
| 智慧之门 | `wisdom.md` | `npm run input:wisdom -- --week YYYY-Www` |
...
1. 采集 `daily.md`、`flomo.md`、`weread.md`、`voice.md`、`calendar.md`、`coach.md` 和 `wisdom.md`，不采集周记，不生成 `_dist`。
...
- [ ] 自动采集项按实际情况生成：`daily.md`、`flomo.md`、`weread.md`、`voice.md`、`calendar.md`、`coach.md`、`wisdom.md`。
