...
description: Review or refine Learn-X prompts and Chat Pack assets under 02_prompts, including intent, context, output, failure modes, and evaluation checks.
---
