# ljg-rank - AI Chat Prompt

> Source: .agents/skills/ljg-rank/SKILL.md
> Purpose: 给领域降秩，找最小生成器
...
---
name: ljg-rank
description: "Use this skill to reduce a field or domain to its irreducible independent generators."
user_invocable: true
---
...
2. 写入 `outputs/ljg-rank/{时间戳}--{领域}的秩__rank.md`
3. 报告文件路径给用户
